...
function renderButtons(){ 
    ...
    $('.animalButton').on('click', function() {
            ...
            var queryURL = "http://api.giphy.com/v1/gifs/search?q=" + p + "&api_key=dc6zaTOxFJmzC&limit=6";
                ...
                .done(function(response) {
                    ...
                    var results = response.data;
                        ...
                        for (var i = 0; i < results.length; i++) {
                            ...
                            var animalImages = $('<img class="animalImage" data-state="still">');
                            animalImages.attr('src', results[i].images.fixed_height.url);
